...
# ### **Transformacion de la tabla "physical_specs"**
...
display(physical_specs_df.limit(10))
...
physical_specs_final_df = physical_specs_drop_column_df.replace({"": "uknown"})
...
# MAGIC %%sql
# MAGIC SELECT file_date, count(1) from dim_physical_specs
